            ...
            <nav
                ...
                <div class="container-fluid px-0">
                    <a class="navbar-brand font-weight-bolder ms-sm-3" href="{{ url('/') }}" rel="tooltip"
                        title="{{ $desa->nama_desa }}" data-placement="bottom" target="_blank">
                        {{ $desa->nama_desa }}
                    </a>
                        ...
                        <ul class="navbar-nav navbar-nav-hover ms-lg-12 ps-lg-5 w-100">
                            ...
                            <li class="nav-item dropdown dropdown-hover mx-2">
                                <a class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center"
                                    ...
                                    aria-expanded="false">
                                    Pages
                                    <img src="{{ asset('assets/web/img/down-arrow-dark.svg') }}" alt="down-arrow"
                                        class="arrow ms-1">
                                </a>
                                            ...
                                            <a class="dropdown-item py-2 ps-3 border-radius-md"
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div
                                                        ...
                                                        <img src="{{ asset('assets/web/img/down-arrow.svg') }}"
                            ...
                            <li class="nav-item my-auto ms-lg-auto ms-3 ms-lg-0">
                                <a href="https://www.creative-tim.com/product/soft-ui-design-system-pro"
                                    class="btn btn-sm btn-outline-primary btn-round mb-0 me-1 mt-2 mt-md-0 visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block">Login
                                    Mandiri</a>
                            </li>
                        </ul>
                    </div>
