...
@section('content')
    ...
    <section class="content">
        <form action="{{ url('desa/profile/' . $profile->id) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="row">
                    ...
                    <div class="card p-3">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control form-control-sm" id="slug" name="slug"
                                readonly value="{{ old('slug', $profile->slug) }}">
                            @error('slug')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group mb-0">
                            ...
                            <textarea id="body" name="body" class="form-control block w-full mt-1 @error('body') is-invalid @enderror">{{ old('body', $profile->body) }}</textarea>
                            @error('body')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card p-3">
                                <div class="form-group mb-0">
                                    <div class="d-flex justify-content-center">
                                        <input type="hidden" name="oldImage1" value="{{ $profile->image1 }}">
                                        @if ($profile->image1)
                                            <img src="{{ asset('storage/' . $profile->image1) }}"
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="caption_image1"
                                            ...
                                            value="{{ old('caption_image1', $profile->caption_image1) }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-4">
                            <div class="card p-3">
                                <div class="form-group mb-0">
                                    <div class="d-flex justify-content-center">
                                        <input type="hidden" name="oldImage2" value="{{ $profile->image2 }}">
                                        @if ($profile->image2)
                                            <img src="{{ asset('storage/' . $profile->image2) }}"
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="caption_image2"
                                            ...
                                            value="{{ old('caption_image2', $profile->caption_image2) }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-4">
                            <div class="card p-3">
                                <div class="form-group mb-0">
                                    <div class="d-flex justify-content-center">
                                        <input type="hidden" name="oldImage3" value="{{ $profile->image3 }}">
                                        @if ($profile->image3)
                                            <img src="{{ asset('storage/' . $profile->image3) }}"
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="caption_image3"
                                            ...
                                            value="{{ old('caption_image2', $profile->caption_image3) }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-md-3 mb-2">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <div class="mb-0">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="caption_image"
                                        ...
                                        value="{{ old('caption_image2', $profile->caption_image) }}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body px-3 pt-0 mt-n2">
                            <div class="form-group mb-2">
                                ...
                                <input type="url" class="form-control form-control-sm" name="link_embed"
                                    ...
                                    value="{{ old('link_embed', $profile->link_embed) }}">
                            </div>
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control form-control-sm" name="sumber_berita"
                                    ...
                                    value="{{ old('sumber_berita', $profile->sumber_berita) }}">
                            </div>
                            <div class="form-group mb-2">
                                ...
                                <input type="url" class="form-control form-control-sm" name="link_sumber_berita"
                                    ...
                                    placeholder="Contoh : https://youtu.be/HR_Piu6qtoI?si=vehl5oEUlotpJxqu"
                                    value="{{ old('link_sumber_berita', $profile->link_sumber_berita) }}">
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div class="card-body px-3 pt-0 mt-n2">
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control form-control-sm" name="dokumen" id="dokumen"
                                    placeholder="Contoh : Berkas Pengesahan"
                                    value="{{ old('dokumen', $profile->dokumen) }}">
                            </div>
                            <div class="form-group mb-2">
                                <label for="link_dokumen" class="form-label text-sm opacity-8">Lampiran Dokumen</label>
                                <input type="hidden" name="oldAttach" value="{{ $profile->link_dokumen }}">
                                @if ($profile->link_dokumen !== null)
                                    <p class="text-xs text-success">{{ $profile->link_dokumen }}</p>
                                @endif
                    ...
                    <a href="{{ url('desa/profile') }}" class="btn btn-sm btn-danger mb-2">Batal</a>
