...
@section('content')
    <section class="content-header">
        {{ Breadcrumbs::render('identitas') }}
    </section>

    <!-- Main content -->
    <section class="content">
        <!-- Default box -->
        <form action="{{ url('desa/identitas/' . $desa->id) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="row">
                <div class="col-xl-3 col-md-3">
                    ...
                    <div class="card mb-3 p-3">
                        <div class="d-flex justify-content-center">
                            <input type="hidden" name="oldTtd" value="{{ $desa->ttd }}">
                            @if ($desa->ttd)
                                <img src="{{ asset('storage/' . $desa->ttd) }}"
                    ...
                    <div class="card mb-3 p-3">
                        <div class="d-flex justify-content-center">
                            <input type="hidden" name="oldBanner" value="{{ $desa->banner }}">
                            @if ($desa->banner)
                                <img src="{{ asset('storage/' . $desa->banner) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control form-control-sm" name="nama_desa"
                                        id="nama_desa" value="{{ old('nama_desa', $desa->nama_desa) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control form-control-sm" name="kode_desa"
                                        id="kode_desa" value="{{ old('kode_desa', $desa->kode_desa) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control form-control-sm" name="niap_kepala_desa"
                                        id="niap_kepala_desa"
                                        value="{{ old('niap_kepala_desa', $desa->niap_kepala_desa) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control form-control-sm" name="telepon_kepala_desa"
                                        ...
                                        value="{{ old('telepon_kepala_desa', $desa->telepon_kepala_desa) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <textarea name="alamat" id="alamat" cols="30" rows="5" class="form-control form-control-sm">{{ old('alamat', $desa->alamat) }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control form-control-sm" name="telepon"
                                        id="telepon" value="{{ old('telepon', $desa->telepon) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control form-control-sm" name="email"
                                        id="email" value="{{ old('email', $desa->email) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input type="url" class="form-control form-control-sm" name="website"
                                        id="website" value="{{ old('website', $desa->website) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control form-control-sm" name="nama_kecamatan"
                                        id="nama_kecamatan" value="{{ old('nama_kecamatan', $desa->nama_kecamatan) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <input type="number" class="form-control form-control-sm" name="kode_kecamatan"
                                        id="kode_kecamatan" value="{{ old('kode_kecamatan', $desa->kode_kecamatan) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control form-control-sm" name="nama_kabupaten"
                                        id="nama_kabupaten" value="{{ old('nama_kabupaten', $desa->nama_kabupaten) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <input type="number" class="form-control form-control-sm" name="kode_kabupaten"
                                        id="kode_kabupaten" value="{{ old('kode_kabupaten', $desa->kode_kabupaten) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-2">
